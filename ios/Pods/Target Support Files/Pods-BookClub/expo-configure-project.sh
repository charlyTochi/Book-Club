...
with_node \
  ...
  --target "/Users/charly/Development/BookClubApp/ios/Pods/Target Support Files/Pods-BookClub/ExpoModulesProvider.swift" \
  --entitlement "/Users/charly/Development/BookClubApp/ios/BookClub/BookClub.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-constants" "expo-file-system" "expo-font" "expo-keep-awake" "expo-splash-screen"
